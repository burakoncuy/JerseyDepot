...
def generate_items():
    ...
    item_data = [
        ...
        ("Chicago Cubs", "Cubs classic pinstripe jersey", 98, "https://lopenix.com/wp-content/uploads/2025/01/dansby-swanson-mens-chicago-cubs-special-vapor-premier-limited-v2-pinstripe-jersey--all-stitched-t2yqr.jpg", categories["BASEBALL"]),
